...
### *Started from March 1st, 2020.*

## Additional Rules
1. I will tweet about my progress every day -> using the #100DaysOfCode.
...
1. To increase the chances of success, it's a requirement that you add a link to each of the day posts in the [log](log.md). It can be a link to a commit on GitHub or a link to a blog post.
